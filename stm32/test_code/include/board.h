...
********************************************************************************/
    ...
    #define BEEPER_GPIO_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE()
...
#endif
#ifdef MASTER_J18
    /* UART5 (J18 Pin 7 (TX) Pin 8 (RX)) */
    #define MASTER_USART_INSTANCE UART5
    #define MASTER_USART_RX_PIN GPIO_PIN_2
    #define MASTER_USART_RX_PORT GPIOD
    #define MASTER_USART_TX_PIN GPIO_PIN_12
    #define MASTER_USART_TX_PORT GPIOC
    #define MASTER_USART_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
    #define MASTER_USART_USART_CLK_ENABLE() __HAL_RCC_UART5_CLK_ENABLE()
    #define MASTER_USART_IRQ UART5_IRQn
#endif
